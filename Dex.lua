...
-- Modified by Vortex. Changed: Language to German
	...
	The main explorer interface
		...
		local function main()
			...
			Explorer.InitRightClick = function()
				...
				context:Register("CUT",{Name = "Ausschneiden", IconMap = Explorer.MiscIcons, Icon = "Cut", DisabledIcon = "Cut_Disabled", Shortcut = "Ctrl+Z", OnClick = function()
				...
				context:Register("COPY",{Name = "Kopieren", IconMap = Explorer.MiscIcons, Icon = "Copy", DisabledIcon = "Copy_Disabled", Shortcut = "Ctrl+C", OnClick = function()
				...
				context:Register("PASTE",{Name = "Einfügen", IconMap = Explorer.MiscIcons, Icon = "Paste", DisabledIcon = "Paste_Disabled", Shortcut = "Ctrl+Shift+V", OnClick = function()
					local sList = selection.List
					local newSelection = {}
					local count = 1
					for i = 1,#sList do
				...
				context:Register("DUPLICATE",{Name = "Duplizieren", IconMap = Explorer.MiscIcons, Icon = "Copy", DisabledIcon = "Copy_Disabled", Shortcut = "Ctrl+D", OnClick = function()
					local clone = game.Clone
					local sList = selection.List
					local newSelection = {}
					local count = 1
				...
				context:Register("DELETE",{Name = "Löschen", IconMap = Explorer.MiscIcons, Icon = "Delete", DisabledIcon = "Delete_Disabled", Shortcut = "Del", OnClick = function()
				...
				context:Register("RENAME",{Name = "Umbenennen", IconMap = Explorer.MiscIcons, Icon = "Rename", DisabledIcon = "Rename_Disabled", Shortcut = "F2", OnClick = function()
					local sList = selection.List
					if sList[1] then
				...
				context:Register("GROUP",{Name = "Gruppieren", IconMap = Explorer.MiscIcons, Icon = "Group", DisabledIcon = "Group_Disabled", Shortcut = "Ctrl+G", OnClick = function()
					local sList = selection.List
				...
				context:Register("UNGROUP",{Name = "Gruppe auflösen", IconMap = Explorer.MiscIcons, Icon = "Ungroup", DisabledIcon = "Ungroup_Disabled", Shortcut = "Ctrl+U", OnClick = function()
					local newSelection = {}
					local count = 1
					local isa = game.IsA
				...
				context:Register("SELECT_CHILDREN",{Name = "Wähle alles darin aus", IconMap = Explorer.MiscIcons, Icon = "SelectChildren", DisabledIcon = "SelectChildren_Disabled", OnClick = function()
					local newSelection = {}
					local count = 1
					local sList = selection.List
				...
				context:Register("JUMP_TO_PARENT",{Name = "Zum Elternteil springen", IconMap = Explorer.MiscIcons, Icon = "JumpToParent", OnClick = function()
					local newSelection = {}
					local count = 1
					local sList = selection.List
				...
				context:Register("TELEPORT_TO",{Name = "Dorthin teleportieren", IconMap = Explorer.MiscIcons, Icon = "TeleportTo", OnClick = function()
					local sList = selection.List
				...
				context:Register("EXPAND_ALL",{Name = "Alle erweitern", OnClick = function()
					local sList = selection.List
				...
				context:Register("COLLAPSE_ALL",{Name = "Alle einklappen", OnClick = function()
					local sList = selection.List
				...
				context:Register("COPY_PATH",{Name = "Pfad kopieren", IconMap = Explorer.ClassIcons, Icon = 50, OnClick = function()
					local sList = selection.List
					if #sList == 1 then
				...
				context:Register("INSERT_OBJECT",{Name = "Objekt einfügen", IconMap = Explorer.MiscIcons, Icon = "InsertObject", OnClick = function()
				...
				context:Register("VIEW_OBJECT",{Name = "Objekt anzeigen (Rechtsklick zum Zurücksetzen)", IconMap = Explorer.ClassIcons, Icon = 5, OnClick = function()
					local sList = selection.List
					local isa = game.IsA
				...
				context:Register("SELECT_CHARACTER",{Name = "Charackter auswählen", IconMap = Explorer.ClassIcons, Icon = 9, OnClick = function()
					local newSelection = {}
					local count = 1
					local sList = selection.List
					local isa = game.IsA
		...
		--[=[if #query > 0 then
			...
			Explorer.Init = function()
				...
				local explorerItems = create({
					...
					{4,"TextBox",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClearTextOnFocus=false,Font=3,Name="SearchBox",Parent={3},PlaceholderColor3=Color3.new(0.39215689897537,0.39215689897537,0.39215689897537),PlaceholderText="Suche Workspace",Position=UDim2.new(0,4,0,0),Size=UDim2.new(1,-24,0,18),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,}},
				...
				window:SetTitle("Explorer (Modified by Vortex)")
		...
		local function main()
			...
			Properties.Init = function() -- TODO: MAKE BETTER
				local guiItems = create({
					...
					{2,"Frame",{BackgroundColor3=Color3.new(0.20392157137394,0.20392157137394,0.20392157137394),BorderSizePixel=0,Name="ToolBar",Parent={1},Size=UDim2.new(1,0,0,22),}},
					{3,"Frame",{BackgroundColor3=Color3.new(0.14901961386204,0.14901961386204,0.14901961386204),BorderColor3=Color3.new(0.1176470592618,0.1176470592618,0.1176470592618),BorderSizePixel=0,Name="SearchFrame",Parent={2},Position=UDim2.new(0,3,0,1),Size=UDim2.new(1,-6,0,18),}},
					{4,"TextBox",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClearTextOnFocus=false,Font=3,Name="SearchBox",Parent={3},PlaceholderColor3=Color3.new(0.39215689897537,0.39215689897537,0.39215689897537),PlaceholderText="Suche Eigenschaften",Position=UDim2.new(0,4,0,0),Size=UDim2.new(1,-24,0,18),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,}},
					{5,"UICorner",{CornerRadius=UDim.new(0,2),Parent={3},}},
					{6,"UIStroke",{Thickness=1.4,Parent={3},Color=Color3.fromRGB(42,42,42)}},
					{7,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.12549020349979,0.12549020349979,0.12549020349979),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Reset",Parent={3},Position=UDim2.new(1,-17,0,1),Size=UDim2.new(0,16,0,16),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,}},
					{8,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="rbxassetid://5034718129",ImageColor3=Color3.new(0.39215686917305,0.39215686917305,0.39215686917305),Parent={7},Size=UDim2.new(0,16,0,16),}},
	...
	A script viewer that is basically a notepad
		...
		local function main()
			...
			ScriptViewer.Init = function()
				window = Lib.Window.new()
				window:SetTitle("Script Ansicht")
				...
				copy.Text = "In die Zwischenablage kopieren"
				...
				dumpbtn.Text = "Funktionen Dumpen"
...
Main = (function()
	...
	Main.CreateMainGui = function()
		...
		Main.CreateApp({Name = "Eigenschaften", IconMap = Main.LargeIcons, Icon = "Properties", Open = true, Window = Properties.Window})

		Main.CreateApp({Name = "Script Anscicht", IconMap = Main.LargeIcons, Icon = "Script_Viewer", Window = ScriptViewer.Window})

		local cptsOnMouseClick = nil
		Main.CreateApp({Name = "Teil anklicken und auswählen", IconMap = Main.LargeIcons, Icon = 6, OnClick = function(callback)
			if callback then
				local mouse = Main.Mouse
